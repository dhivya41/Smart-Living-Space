...
if(isset($_GET['on']))
{
    ...
    mysqli_query($connect,"UPDATE `garden` SET `pump`=1 ")or die(mysqli_error($connect));

	echo ' <script language="javascript" type="text/javascript">
parent.document.location="garden.php";
</script>';
...
if(isset($_GET['off']))
{
    ...
    mysqli_query($connect,"UPDATE `garden` SET `pump`=0 ")or die(mysqli_error($connect));
...
{
	echo ' <script language="javascript" type="text/javascript">
parent.document.location="l1real.php";
</script>';
...
{
	echo ' <script language="javascript" type="text/javascript">
parent.document.location="load2.php";
</script>';
}
	
	
$query=mysqli_query($connect,"SELECT * FROM `garden` WHERE 1 ") or die(mysqli_error($connect));
...
<br><br>
<center><h3 style="font-weight: bold; color: green">Garden Side Automation System</h3></center>
<br><br>
...
<div class="row">
  ...
  <div class="column">
    <div class="card">
      <h3>Soil Moisture Values</h3>
	 <img src="soil.png" alt="Nature" width="200px" height="200px"><br><br>
     Soil Moisture : <?php echo $sm ?>
...
<div class="row">
  ...
  <div class="column">
    <div class="card">
     ...
     Pump : <button type="submit" name="on" class="registerbtn">ON</button> &nbsp&nbsp <button type="submit" name="off" class="registerbtn">OFF</button>
    <br><br>
     Pump Status : <?php echo $pump ?>
